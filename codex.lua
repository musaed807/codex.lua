if (game:GetService("CoreGui")):FindFirstChild("codex") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).codex:Destroy();
...
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("codex")).Enabled = not (game.CoreGui:FindFirstChild("codex")).Enabled;
end);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("codex") then
			makefolder("codex");
		end;
		if not isfolder("codex/Library/") then
			makefolder("codex/Library/");
		end;
		if not isfile(("codex/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("codex/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("codex/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("codex/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("codex/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local codex = Instance.new("ScreenGui");
	codex.Name = "codex";
	codex.Parent = game.CoreGui;
	codex.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = codex;
