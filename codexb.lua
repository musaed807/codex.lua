print("✅ Security verification passed. Loading Codex...")
...
local Update = (loadstring(Game:HttpGet("https://raw.githubusercontent.com/musaed807/codex.lua/refs/heads/main/codex.lua")))();
...
(getgenv()).Load = function()
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("codex/Blox Fruits/") then
			makefolder("codex/Blox Fruits/");
		end;
		if not isfile(("codex/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("codex/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("codex/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
	...
	if Update:SaveSettings() then
		if readfile and writefile and isfile and isfolder then
			if not isfile(("codex/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
				...
				writefile("codex/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
			end;
		else
			return warn("Status : Undetected Executor");
		end;
...
MainTab:Button("Copy Discord Link", function()
	setclipboard("https://discord.gg/hm9yYVfMyW");
